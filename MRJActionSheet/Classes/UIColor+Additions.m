...
-(UIColor *)mixWithColor:(UIColor *)color ratio:(CGFloat)ratio
{
    if(ratio > 1)
        ratio = 1;
...
- (NSString *)hexStringFromColor {
	return [NSString stringWithFormat:@"%0.6X", (uint)self.rgbHex];
}
...
+ (UIColor *)colorWithDecimalString:(NSString *)stringToConvert {
	...
	switch (i) {
		case 2: // monochrome
			...
			break;
		case 4: // RGB
			color = [UIColor colorWithRed:c[0]/255.0 green:c[1]/255.0 blue:c[2]/255.0 alpha:c[3]/255.0];
			break;
		default:
			color = nil;
	}
